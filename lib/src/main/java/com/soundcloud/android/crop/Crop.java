...
public class Crop {
     ...
     * @param fragment Fragment to receive result
     */
    public void start(Context context, androidx.core.app.Fragment fragment) {
        start(context, fragment, REQUEST_CROP);
    }
     ...
     * @param requestCode requestCode for result
     */
    public void start(Context context, androidx.core.app.Fragment fragment, int requestCode) {
        fragment.startActivityForResult(getIntent(context), requestCode);
    }
     ...
     * @param fragment Fragment to receive result
     */
    public static void pickImage(Context context, androidx.core.app.Fragment fragment) {
        pickImage(context, fragment, REQUEST_PICK);
    }
     ...
     * @param requestCode requestCode for result
     */
    public static void pickImage(Context context, androidx.core.app.Fragment fragment, int requestCode) {
        try {
            fragment.startActivityForResult(getImagePicker(), requestCode);
        } catch (ActivityNotFoundException e) {
            showImagePickerError(context);
